...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across ITSG|CERT.at|Mindeststandard guidelines and technical reports. Covers ITSG|CERT.at|Mindeststandard series, ITSG|CERT.at|Mindeststandard implementation guides, and CCN technical reports.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'cifrado TLS', 'ITSG|CERT.at|Mindeststandard medidas seguridad')" },
        type: {
          type: "string",
        ...
        series: {
          type: "string",
          enum: ["ITSG|CERT.at|Mindeststandard", "ITSG|CERT.at|Mindeststandard", "ITSG|CERT.at|Mindeststandard"],
  ...
  },
  {
    ...
    description:
      "Get a specific CCN guidance document by reference (e.g., 'ITSG|CERT.at|Mindeststandard-807', 'ITSG|CERT.at|Mindeststandard-830').",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "Search ITSG|CERT.at|Mindeststandard security advisories and alerts. Returns advisories with severity, affected products, and CVE references.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Get a specific ITSG|CERT.at|Mindeststandard security advisory by reference (e.g., 'ITSG|CERT.at|Mindeststandard-AV-24/001').",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "ITSG|CERT.at|Mindeststandard advisory reference" },
      },
      required: ["reference"],
    },
  },
  {
    ...
    description:
      "List all ITSG|CERT.at|Mindeststandard frameworks and standard series covered in this MCP.",
...
const SearchGuidanceArgs = z.object({
  ...
  series: z.enum(["ITSG|CERT.at|Mindeststandard", "ITSG|CERT.at|Mindeststandard", "ITSG|CERT.at|Mindeststandard"]).optional(),
      ...
      switch (name) {
        ...
        case "at_cyber_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "ITSG|CERT.at|Mindeststandard (Centro Criptológico Nacional CERT — Spanish National Cryptologic Centre CERT) MCP server. Provides access to ITSG|CERT.at|Mindeststandard technical guidelines, ITSG|CERT.at|Mindeststandard implementation guides, and security advisories.",
            data_source: "ITSG|CERT.at|Mindeststandard (https://www.ccn-cert.cni.es/)",
